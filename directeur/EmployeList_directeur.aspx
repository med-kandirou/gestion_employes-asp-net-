<%@ Page Title="" Language="C#" MasterPageFile="~/Master_dir.Master" AutoEventWireup="true" CodeBehind="~/directeur/EmployeList_directeur.aspx.cs" Inherits="Projet_Fin_Formation.WebForm9" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td class="auto-style3">
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnAddEmp" style="margin-left:500px;" runat="server" CssClass="btn btn-outline-success" Text="Ajouter Employee" OnClick="btnAddEmp_Click" />
            <br />
            <br />
        </td>
